...
TutorialScene::TutorialScene()
{
	...
	_block2->SetPosition(Vector2(_radder1->GetSize() - 50.0f, 150.0f) - CENTER + Vector2(800.0f, 100.0f));
...
void TutorialScene::Update()
{
	...
	if (_block2->Block(_player->GetCollider()) && _block2->GetCollider()->IsCollision(_player->GetFeetCollider()))
		check = true;
